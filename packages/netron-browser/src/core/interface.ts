 ...
 * @property {IPeer} $peer - The peer instance responsible for network communication
 */
export class Interface {
   ...
   *                            methods and properties
   * @param {IPeer} [peer] - The peer instance responsible for network communication
  ...
  private $processValue(value: any): any {
    if (value instanceof Interface) {
      ...
      throw new Error('Unsupported value type: Direct service exposure is not yet implemented');
   ...
   * @param {IPeer} peer - The peer instance
