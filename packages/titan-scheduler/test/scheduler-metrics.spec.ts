...
import { SchedulerMetricsService } from '../src/scheduler.metrics.js';
...
describe('Scheduler Metrics', () => {
  ...
  describe('Job-Specific Metrics', () => {
    it('should get metrics for specific job', () => {
      const _job: IScheduledJob = registry.registerJob('test-job', SchedulerJobType.CRON, '* * * * *', {}, 'run', {});
  ...
  describe('Metrics Update Events', () => {
    ...
    it('should include metrics in update event', () =>
      new Promise<void>((done) => {
