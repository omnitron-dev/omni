...
$omnitron start -f params_check.js --merge-logs -o args.log --name 'some-project' -- \
     --logger.level=info \
...
$omnitron start -f params_check.js echo.js --merge-logs -o args.log -- argv1 argv1 argv2 argv3
