...
export class ValidationMiddleware {
  ...
  private wrapAsyncMethod(
    ...
    return async function validatedAsyncMethod(this: any, ...args: any[]) {
  ...
  private wrapStreamingMethod(
    ...
    return async function* validatedStreamingMethod(this: any, ...args: any[]) {
      // Use provided context or target
      const context = this || target;
      ...
      return new Proxy(wrappedService as any, {
        get(target, prop) {
          ...
          if (typeof original === 'function') {
            return async function validatedHandlerMethod(...args: any[]) {
