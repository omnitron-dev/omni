...
import { signal, effect, batch, createRoot } from '../../../../src/core/reactivity/index.js';
  ...
  describe('Regression test for issue #06-sample', () => {
    it('should produce correct output for example 06-sample.ts', () => {
      ...
      try {
        ...
        expect(output).toEqual(['Counter: 0', 'Counter: 1', 'Counter: 2']);
      } finally {
        // Restore console.log
