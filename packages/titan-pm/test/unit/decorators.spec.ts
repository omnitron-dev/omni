 ...
 * - @Public - Decorator for exposing methods and properties
...
import type { ICircuitBreakerOptions } from '../../src/types.js';
...
describe('PM Decorators', () => {
  ...
  describe('@Public', () => {
    it('should mark method as public', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'publicMethod');
    ...
    it('should not affect non-decorated methods', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'privateMethod');
  ...
  describe('@RateLimit', () => {
    it('should set rate limit metadata', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'rateLimitedMethod');
  ...
  describe('@Cache', () => {
    it('should set cache metadata', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'cachedMethod');
    ...
    it('should use default options if none provided', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'defaultCachedMethod');
  ...
  describe('@Validate', () => {
    it('should set validation metadata', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'validatedMethod');
  ...
  describe('@Trace', () => {
    it('should set trace metadata', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'tracedMethod');
  ...
  describe('@Metric', () => {
    it('should set metrics flag to true', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'metricMethod');
    ...
    it('should enable metrics even without name parameter', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'defaultMetricMethod');
  ...
  describe('@Workflow, @Stage, and @Compensate', () => {
    ...
    it('should register workflow stages', () => {
      // Stages are stored by stage name (from options.name), not by method name
      class TestWorkflow {
        ...
        @Stage({ name: 'transform', order: 2, dependsOn: ['extract'] })
        async transformData() {
      ...
      // Stages are stored by stage name (options.name)
      const extractStage = metadata.stages.get('extract');
      expect(extractStage).toBeDefined();
      expect(extractStage.order).toBe(1);

      const transformStage = metadata.stages.get('transform');
      expect(transformStage).toBeDefined();
      expect(transformStage.dependsOn).toContain('extract');
    });
  ...
  describe('Decorator Composition', () => {
    it('should allow multiple decorators on same method', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TestClass.prototype, 'composedMethod');
  ...
  describe('@RateLimit decorator - Strategies', () => {
    ...
    it('should allow rate limit key for per-user limiting', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, PerUserService.prototype, 'perUserMethod');
  ...
  describe('@Cache decorator - Comprehensive', () => {
    it('should store TTL configuration', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, TTLCacheService.prototype, 'ttlMethod');
    ...
    it('should store string key function', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, KeyCacheService.prototype, 'keyMethod');
    ...
    it('should store function key generator', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, FnKeyCacheService.prototype, 'fnKeyMethod');
    ...
    it('should allow empty options for default caching', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, DefaultCacheService.prototype, 'defaultMethod');
  ...
  describe('@Validate decorator - Comprehensive', () => {
    it('should store JSON schema validation', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, SchemaValidateService.prototype, 'createUser');

      expect(metadata.validate.schema).toEqual(userSchema);
    });

    it('should store custom validator function', () => {
      const customValidator = (value: any): boolean => !!(value && value.id && typeof value.id === 'string');
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, CustomValidateService.prototype, 'processData');
    ...
    it('should store async validator function', () => {
      const asyncValidator = async (value: any) =>
        ...
        Promise.resolve(value && value.valid === true);
  ...
  describe('Edge Cases', () => {
    it('should handle symbol property keys', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, SymbolService.prototype, symbolKey);
    ...
    it('should handle null/undefined in cache condition', () => {
      ...
      const metadata = Reflect.getMetadata(PROCESS_METHOD_METADATA_KEY, NullHandlingService.prototype, 'method');
