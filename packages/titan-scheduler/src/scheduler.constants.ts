...
export const SCHEDULER_METADATA = {
  CRON_JOB: Symbol.for('titan:scheduler:cron'),
  INTERVAL: Symbol.for('titan:scheduler:interval'),
  TIMEOUT: Symbol.for('titan:scheduler:timeout'),
  SCHEDULED_JOB: Symbol.for('titan:scheduler:job'),
  JOB_OPTIONS: Symbol.for('titan:scheduler:options'),
} as const;
