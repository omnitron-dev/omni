...
$omnitron start echo.js --namespace e2e-test-log-namespace

LOG_FILE_BASELINE="${LOG_PATH_PREFIX}/baseline-out.log"
$omnitron logs e2e-test-log-namespace > $LOG_FILE_BASELINE & # backgrounded - will be stopped by `$omnitron delete all`
...
$omnitron logs e2e-test-log-namespace --lines 0 > $LOG_FILE_LINES_ZERO &
