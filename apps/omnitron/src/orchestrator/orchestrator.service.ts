 ...
 *
 * Examples:
 *   effectiveAppName('omni/dev/payments') === 'payments'
 *   effectiveAppName('payments')           === 'payments'
 *   effectiveAppName('a/b/c/payments')     === 'payments'  (last segment)
 */
...
export class OrchestratorService extends EventEmitter {
   ...
   *
   * Inputs accepted:
   *   - exact canonical key (`omni/dev/payments`) → returned as-is
   ...
   * was never what anyone saw: `acme/dev/main` reported 122 MB against 437 MB
