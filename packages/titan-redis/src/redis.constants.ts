export const REDIS_MODULE_OPTIONS = Symbol.for('titan:REDIS_MODULE_OPTIONS');
export const REDIS_MANAGER = Symbol.for('titan:REDIS_MANAGER');
export const REDIS_CLIENT = Symbol.for('titan:REDIS_CLIENT');
 ...
 */
export const getRedisClientToken = (namespace?: string): string =>
  namespace && namespace !== REDIS_DEFAULT_NAMESPACE
