...
export function createMockLogger(): ILogger {
  ...
  const logger = {
    trace: vi.fn((obj: any, msg?: string, ...args: any[]) => {}),
    debug: vi.fn((obj: any, msg?: string, ...args: any[]) => {}),
    info: vi.fn((obj: any, msg?: string, ...args: any[]) => {}),
    warn: vi.fn((obj: any, msg?: string, ...args: any[]) => {}),
    error: vi.fn((obj: any, msg?: string, ...args: any[]) => {}),
    fatal: vi.fn((obj: any, msg?: string, ...args: any[]) => {}),
    ...
    getLevel: vi.fn(() => currentLevel as any),
  };
...
export function createStreamLogger(writable: Writable, level: string = 'info'): ILogger {
  ...
  const logger: ILogger = {
    ...
    level: level as any,
    setLevel: vi.fn((newLevel: string) => {
      (logger as any).level = newLevel;
    }),
    isLevelEnabled: vi.fn((checkLevel: string) => {
...
export async function createNetronServer(options: {
  ...
  const { WebSocketTransport } = await import('../../src/netron/transport/websocket/index.js');
