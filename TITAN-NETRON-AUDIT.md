...
- [ ] **U-P2 module-consumption uniformity (sensible default = unify on Titan) — INVESTIGATED, next focused pass:**
  ...
  - **Metrics:** converge storage/payments/pricing/geo `XMetricsService extends titan MetricsService` into `createDomainMetrics(prefix, defs)` (needs per-app metric-def survey).
