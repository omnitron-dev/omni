...
describe('nodeify', () => {
  it('should pass the value as the second argument', async () => {
  ...
  it('should pass null as the first argument if there is no error', async () => {
    await new Promise<void>((resolve) => {
  ...
  it('should pass the error as the first argument', async () => {
    await new Promise<void>((resolve) => {
  ...
  it('should not pass the second argument if there is an error', async () => {
    await new Promise<void>((resolve) => {
