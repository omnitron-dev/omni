...
if (skipTests) {
  console.log('⏭️ Skipping edge-cases.spec.ts - requires real Redis');
}
...
describeOrSkip('Rotif - Edge Cases', () => {
  ...
  describe('timing edge cases', () => {
    ...
    it('should handle rapid publish calls', async () => {
      ...
      await delay(20000); // 100 messages with sequential Lua script processing need time

      // All 100 messages should be processed through the consumer loop
  ...
  describe('retry edge cases', () => {
    ...
    it('should handle very high maxRetries', async () => {
      ...
      await delay(10000); // Retries have delays, need more time
