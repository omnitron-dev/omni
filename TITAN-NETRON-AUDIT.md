...
- **PROPAGATION (verified):** downstream apps consume titan via `link:.../omni/packages/titan*` (pnpm filesystem links) → ALL framework fixes in this session are ALREADY live in the 8 backends; no republish/bump needed.
