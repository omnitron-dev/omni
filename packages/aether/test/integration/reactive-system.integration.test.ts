  ...
  describe('Complete reactive flow', () => {
    it('should handle complex reactive graph', () => {
      ...
      createRoot((d) => {
        ...
        // Update last name
        lastName.set('Smith');
        expect(results).toEqual(['Hello, John Doe!', 'Hello, Jane Doe!', 'Hello, Jane Smith!']);
      ...
      expect(results).toEqual(['Hello, John Doe!', 'Hello, Jane Doe!', 'Hello, Jane Smith!', 'Hello, Bob Johnson!']);
    });
  ...
  describe('Batching and performance', () => {
    it('should batch updates across multiple stores and signals', () => {
      ...
      createRoot((d) => {
        ...
        const totalComputed = computed(() => counter1() + counter2() + state.get('value'));
  ...
  describe('Complex real-world scenarios', () => {
    it('should handle todo app state management', () => {
      ...
      createRoot((d) => {
        ...
        const activeCountComputed = computed(() => todos.get('items').filter((t) => !t.completed).length);
  ...
  describe('Memory and performance', () => {
    it('should handle large reactive graphs efficiently', () => {
      ...
      createRoot((d) => {
        ...
        const sumComputed = computed(() => signals.reduce((acc, s) => acc + s(), 0));
