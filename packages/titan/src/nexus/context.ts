...
export const ContextKeys = {
  ...
  AuthContext: createContextKey<{ userId: string; roles: string[]; permissions: string[]; scopes?: string[] }>(
    'authContext'
  ),
...
export interface ResolutionStrategy {
   ...
   */
  select(providers: any[], context: ResolutionContext): any;
}
...
export function getCurrentAuthContext():
  | { userId: string; roles: string[]; permissions: string[]; scopes?: string[] }
  | undefined {
