...
import { isDockerAvailable } from './docker-test-utils.js';

const skipIntegrationTests = !isDockerAvailable();

if (skipIntegrationTests) {
  console.log('⏭️ Skipping redis-auto-setup.demo.spec.ts - requires Docker');
}
...
describeOrSkip('Redis Auto-Setup - Timeout Configuration', () => {
...
describeOrSkip('Redis Auto-Setup - Verbose Mode', () => {
