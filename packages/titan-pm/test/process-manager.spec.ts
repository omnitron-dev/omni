...
import { Process, Public, RateLimit, HealthCheck } from '../src/decorators.js';
...
// Register MockProcessSpawner for Jest tests
...
describe('ProcessManager', () => {
  ...
  describe('Process Lifecycle', () => {
    ...
    it('should handle graceful shutdown', async () => {
      const _service1 = await pm.spawn(TestService);
      const _service2 = await pm.spawn(TestService);
    ...
    it('should handle forced shutdown', async () => {
      const _service = await pm.spawn(TestService);
...
describe('Streaming', () => {
  ...
  it('should handle streaming methods [MockSpawner: async generator proxy support]', async () => {
  ...
  it('should handle empty streams [MockSpawner: async generator proxy support]', async () => {
    const service = await pm.spawn(StreamingService);
...
describe('ProcessManager - Edge Cases', () => {
  ...
  it('should handle shutdown with active pools', async () => {
    ...
    const _promise1 = pool1.increment();
    const _promise2 = pool2.increment();
