...
export default defineConfig({
  ...
  test: {
    ...
    alias: [
      ...
      { find: /^@omnitron-dev\/titan-database$/, replacement: resolve(__dirname, './src/index.ts') },
      { find: /^@omnitron-dev\/titan-redis$/, replacement: resolve(__dirname, '../titan-redis/src/index.ts') },
      ...
      // NOTE: @kysera/* packages use real implementations (not mocks) for titan-database
      // integration tests. The mocks in titan/test/__mocks__/ are for titan's own unit tests.
    ],
  },
  resolve: {
