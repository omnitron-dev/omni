...
// Import the reset function directly from runtime module for test cleanup
// This is an internal API but necessary for proper test isolation
import { resetRuntimeInfo } from '../../../src/nexus/runtime.js';

describe('Runtime Detection', () => {
  afterEach(async () => {
    // Clear the cached runtime info to ensure test isolation
    resetRuntimeInfo();
    ...
    it('should handle different runtime environments gracefully', () => {
      ...
      switch (info.runtime) {
        ...
        case Runtime.Unknown:
          ...
          break;
        default:
          // Handle any future runtime additions
