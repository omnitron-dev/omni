...
describe('Custom Decorators', () => {
  describe('createDecorator', () => {
    ...
    it('should create a method decorator with options', () => {
      ...
      const Log = createDecorator<LogOptions>()
        ...
        .forMethod((context) => {
          ...
          context.descriptor!.value = function logWrapper(...args: any[]) {
    ...
    it('should support decorator composition', () => {
      ...
      const First = createDecorator()
        ...
        .forMethod((context) => {
          const originalMethod = context.descriptor!.value;
          context.descriptor!.value = function firstWrapper(...args: any[]) {
            calls.push('first');
            return originalMethod.apply(this, args);
          };
          return context.descriptor;
      ...
      const Second = createDecorator()
        ...
        .forMethod((context) => {
          const originalMethod = context.descriptor!.value;
          context.descriptor!.value = function secondWrapper(...args: any[]) {
            calls.push('second');
            return originalMethod.apply(this, args);
          };
          return context.descriptor;
    ...
    it('should support metadata transformers', () => {
      ...
      const _metadataKeys = Reflect.getMetadataKeys(TestClass);
  ...
  describe('Utility functions', () => {
    it('should combine decorators correctly', () => {
      ...
      const A = (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
        ...
        descriptor.value = function decoratorA(...args: any[]) {
          calls.push('A');
          return originalMethod.apply(this, args);
        };
        return descriptor;
      ...
      const B = (target: any, propertyKey: string, descriptor: PropertyDescriptor) => {
        const originalMethod = descriptor.value;
        descriptor.value = function decoratorB(...args: any[]) {
          calls.push('B');
          return originalMethod.apply(this, args);
        };
        return descriptor;
  ...
  describe('Complex scenarios', () => {
    it('should work with inheritance', () => {
      ...
      class _DerivedClass extends BaseClass {}
    ...
    it('should handle decorator priority', () => {
      ...
      const HighPriority = createDecorator()
        ...
        .forMethod((context) => {
          const originalMethod = context.descriptor!.value;
          context.descriptor!.value = function highPriorityWrapper(...args: any[]) {
            execOrder.push(10);
            return originalMethod.apply(this, args);
          };
          return context.descriptor;
      ...
      const LowPriority = createDecorator()
        ...
        .forMethod((context) => {
          const originalMethod = context.descriptor!.value;
          context.descriptor!.value = function lowPriorityWrapper(...args: any[]) {
            execOrder.push(1);
            return originalMethod.apply(this, args);
          };
          return context.descriptor;
