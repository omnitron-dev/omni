...
describe('NetronDiscoveryIntegration', () => {
  ...
  let mockDiscovery: vi.Mocked<IDiscoveryService>;
  ...
  beforeEach(() => {
    ...
    mockDiscovery = {
      ...
      deregisterNode: vi.fn().mockResolvedValue(undefined),
      getActiveNodes: vi.fn().mockResolvedValue([]),
      findNodesByService: vi.fn().mockResolvedValue([]),
      isNodeActive: vi.fn().mockResolvedValue(true),
      updateNodeAddress: vi.fn().mockResolvedValue(undefined),
      updateNodeServices: vi.fn().mockResolvedValue(undefined),
      onEvent: vi.fn(),
      offEvent: vi.fn(),
  ...
  describe('Cleanup', () => {
    it('should remove event listeners on destroy', async () => {
      const offSpy = vi.spyOn(mockNetron, 'off');
