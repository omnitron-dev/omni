...
impl DependencyResolver {
    pub fn new(progress_manager: Arc<RwLock<ProgressManager>>) -> Self {
...
mod tests {
    ...
    async fn create_test_resolver() -> (DependencyResolver, TempDir) {
        ...
        let progress_storage = Arc::new(ProgressStorage::new(storage));
        let progress_manager = Arc::new(RwLock::new(ProgressManager::new(progress_storage)));
