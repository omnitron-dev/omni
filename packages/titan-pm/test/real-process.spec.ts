...
import { ProcessStatus, PoolStrategy } from '../src/types.js';
import {
  CalculatorService,
  CounterService,
  StreamService,
...
describe('Real Process Manager', () => {
  ...
  describe('Process Lifecycle', () => {
    ...
    it('should restart a crashed process', async () => {
      ...
      const _originalId = service.__processId;
...
describe('Advanced Features', () => {
  ...
  describe('Streaming Support', () => {
    it('should handle async generators across processes [MockSpawner: async generator proxy support]', async () => {
    ...
    it('should stream fibonacci sequence [MockSpawner: async generator proxy support]', async () => {
      const service = await pm.spawn(StreamService);
