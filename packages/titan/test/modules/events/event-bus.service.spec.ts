...
describe('EventBusService', () => {
  ...
  afterEach(async () => {
    // Clean up service properly
    if (service) {
      await service.onDestroy().catch(() => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle async listener errors', async () => {
      ...
      // Allow async error to propagate with buffer
  ...
  describe('Parallel and Sequential Execution', () => {
    it('should emit events in parallel', async () => {
      ...
      // Add buffer for timing variance in parallel test execution
    ...
    it('should emit events sequentially', async () => {
      ...
      // Reduce strictness for parallel test execution
  ...
  describe('Integration', () => {
    it('should work with complex event flow', async () => {
      ...
      // Allow async events to complete with buffer
      await new Promise((resolve) => setTimeout(resolve, 50));
