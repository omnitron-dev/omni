...
import type { EventInterceptor, ValidationSchema, ListenerFn } from '../src/types.js';
...
describe('EnhancedEventEmitter', () => {
  ...
  describe('Type-Safe Events', () => {
    ...
    it('should provide type-safe emit and on', () => {
      ...
      const listener = vi.fn<ListenerFn<{ id: number; name: string }>>();
  ...
  describe('Interceptors', () => {
    it('should apply global before interceptor', () => {
      const interceptor: EventInterceptor = {
        before: vi.fn((event, data: any) => ({ ...data, intercepted: true })),
      };
    ...
    it('should apply event-specific interceptor', () => {
      const interceptor: EventInterceptor = {
        before: vi.fn((event, data: any) => ({ ...data, specific: true })),
      };
