...
} from '@omnitron-dev/testing/docker';
...
export function withRedis(options?: { db?: number }) {
  return function redisDecorator(target: DecoratorTarget, propertyKey: string, descriptor: PropertyDescriptor) {
    const originalMethod = descriptor.value as (...args: unknown[]) => Promise<unknown>;

    descriptor.value = async function redisTestWrapper(this: unknown, ...args: unknown[]) {
