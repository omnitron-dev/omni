...
// Make test-compatible APIs globally available
...
(global as any).vi = {
  ...
  isMockFunction: (fn: any) => typeof fn === 'function' && typeof fn.mock !== 'undefined',
