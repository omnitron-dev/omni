...
export const isZodType = (obj: unknown): obj is z.ZodTypeAny => typeof (obj as z.ZodTypeAny)?.safeParse === 'function';
...
export const isZodObjectStrict = (obj: unknown): obj is z.AnyZodObject => typeof (obj as z.AnyZodObject)?.passthrough === 'function';
