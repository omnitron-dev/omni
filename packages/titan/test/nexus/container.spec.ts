...
import { Injectable, Inject, Optional, Singleton } from '../../src/decorators/index.js';
...
describe('Container - Comprehensive Tests', () => {
  ...
  describe('Resolution', () => {
    ...
    it('should resolve optional dependencies', () => {
      ...
      class ServiceWithOptional {
        constructor(@Optional() @Inject(optionalToken) public opt?: string) {}
      }
  ...
  describe('Module System', () => {
    it('should load module with providers', () => {
      ...
      const testModule = {
        name: 'TestModule',
        providers: [[TestToken, { useValue: 'test-value' }]],
      };
  ...
  describe('Extensions and Middleware', () => {
    it('should install extension', () => {
      const extension = {
        install: vi.fn(),
      };

      container.use(extension);
      expect(extension.install).toHaveBeenCalledWith(container);
    });

    it('should execute lifecycle hooks via addHook', () => {
    ...
    it('should add middleware', () => {
      const middleware = {
        name: 'TestMiddleware',
        execute: vi.fn((context, next) => next()),
      };
  ...
  describe('Lazy Resolution', () => {
    it('should create lazy proxy', () => {
      const resolveSpy = vi.fn(() => ({ getValue: () => 'lazy-value' }));
  ...
  describe('Context Management', () => {
    ...
    it('should run code within context', () => {
      const result = container.withContext(() => 'context-result');
