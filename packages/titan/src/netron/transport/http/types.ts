 ...
 * netron-browser. Re-exported here so existing `./types.js` importers are unchanged.
 */
...
export interface HttpResponseHints {
  ...
  cache?: {
    ...
    etag?: string;
    /** Last modified timestamp (ISO string or epoch milliseconds) */
    ...
    noStore?: boolean;
    /** Indicates this is a 304 Not Modified response (internal use) */
    notModified?: boolean;
  };
  /** Performance metrics */
  metrics?: {
