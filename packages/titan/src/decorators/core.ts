 ...
 * ```typescript
 * import { Service, Public, Inject } from '@omnitron-dev/titan/decorators';
 *
 ...
 *
 * This decorator was formerly named @Method but renamed to @Public for clarity
 * since it works for both methods and properties in binary transports.
 *
...
// ============================================================================
// These decorators can be used alongside @Public() for cleaner separation of concerns.
 ...
 * Use alongside @Public() for cleaner separation of concerns.
 *
 * @example
 * ```typescript
 * @Public()
