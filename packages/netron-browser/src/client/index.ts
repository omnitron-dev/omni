...
import { WebSocketClient, type WebSocketClientOptions, type TaskHandler } from './ws-client.js';
import { MultiBackendClient, createMultiBackendClient } from './multi-backend-client.js';
...
export type { HttpClientOptions, WebSocketClientOptions, TaskHandler };

// Multi-backend exports
export { MultiBackendClient, createMultiBackendClient, BackendClient, BackendPool };
export type { BackendClientOptions, BackendPoolOptions };
