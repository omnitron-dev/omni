...
describe('SecretManager', () => {
  ...
  describe('initialization', () => {
    ...
    it('should handle initialization errors', async () => {
      ...
      errorProvider.initialize = jest.fn().mockRejectedValue(new Error('Init failed'));
  ...
  describe('validation', () => {
    ...
    it('should validate key format', async () => {
      const validKeys = ['simple-key', 'key_with_underscore', 'key.with.dots', 'KEY-123', 'a', '1234'];
  ...
  describe('error handling', () => {
    ...
    it('should wrap provider errors', async () => {
      const errorProvider = new MockProvider();
      errorProvider.get = jest.fn().mockRejectedValue(new Error('Provider error'));
