...
} from '../../src/enterprise/self-healing.js';
...
describe('Self-Healing Manager', () => {
  ...
  describe('Health Monitoring', () => {
    ...
    it('should track recovery from degradation', () =>
      new Promise<void>((done) => {
  ...
  describe('Healing Actions', () => {
    ...
    it('should execute healing action', () =>
      new Promise<void>((done) => {
  ...
  describe('Playbook Execution', () => {
    ...
    it('should execute rollback on playbook failure', async () => {
      ...
      (manager as any).playbookExecutor.execute = vi.fn().mockRejectedValue(new Error('Playbook failed'));
...
describe('Playbook Executor', () => {
  ...
  it('should execute failure handler on step failure', async () => {
    ...
    (executor as any).executeStep = vi
      .fn()
  ...
  it('should throw if no failure handler defined', async () => {
    ...
    (executor as any).executeStep = vi.fn().mockRejectedValue(new Error('Failed'));
