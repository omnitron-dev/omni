 ...
 *
 * SHARED-PROTO: re-exported from `@omnitron-dev/netron-protocol` (the single
 * source of truth shared with netron-browser) so existing `./constants.js`
 * importers of `MAX_UID_VALUE` are unaffected.
 *
