import { IModule, ProviderDefinition, InjectionToken } from '@omnitron-dev/titan/nexus';
import { Application } from '@omnitron-dev/titan/application';
import type { IApplicationConfig } from '@omnitron-dev/titan/application';

// Import TestContainer from local nexus testing utilities (now in this package)
import { TestContainer, createTestContainer } from './nexus/test-container.js';
