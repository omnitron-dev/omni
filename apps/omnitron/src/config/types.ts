...
export interface OmnitronAppConfig {
  ...
  services?: {
    ...
    /** Cross-app: read pricing price data from its Redis DB */
    pricing?: boolean;
  };
...
export interface IStackConfig {
   ...
   *   // Only payments's monero uses a custom image:
   *   'payments/monero-daemon': { docker: { image: 'custom-monerod:latest' } },
   * }
   */
