...
import type { IApplicationOptions } from '@omnitron-dev/titan/application';
...
export class TestApplication {
   ...
   */
  spyOn<T>(service: T, method: keyof T): any {
    const spy = vi.spyOn(service as any, method as any);
