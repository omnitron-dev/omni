...
import { Prettify, AreAllPropertiesOptional } from './type-utils';
import { AppRoute, AppRouter, isAppRoute, AppRouteMutation } from './dsl';
import {
  ClientInferRequest,
...
const normalizeHeaders = (headers: Record<string, string | undefined>) => Object.fromEntries(
...
>(
  router: T,
  args: TClientArgs,
): InitClientReturn<T, TClientArgs> => Object.fromEntries(
