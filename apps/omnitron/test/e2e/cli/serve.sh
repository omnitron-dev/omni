...
$omnitron serve . $PORT --basic-auth-username user --basic-auth-password pass
should 'should have started serving dir' 'online' 1
...
$omnitron start ecosystem-serve.json
should 'should have started serving dir' 'online' 1
...
$omnitron serve . $PORT_2 --name frontend
should 'should have started serving dir' 'online' 1
