...
describe('Fluent API Integration', () => {
  ...
  describe('Natural Method Calls', () => {
    it('should support natural method call syntax', async () => {
      ...
      vi.spyOn(mockTransport, 'invoke').mockResolvedValue({ id: '123', name: 'John', email: 'john@example.com' });
    ...
    it('should execute method with accumulated options', async () => {
      ...
      const invokeSpy = vi.spyOn(mockTransport, 'invoke').mockResolvedValue({
        id: '123',
        name: 'John',
  ...
  describe('Backward Compatibility', () => {
    it('should support direct api proxy', async () => {
      ...
      vi.spyOn(transport, 'invoke').mockResolvedValue({ id: '123', name: 'John', email: 'john@example.com' });
  ...
  describe('Cache Integration', () => {
    it('should cache results with fluent API', async () => {
      ...
      let callCount = 0;
      vi.spyOn(transport, 'invoke').mockImplementation(async () => {
        callCount++;
  ...
  describe('Transform and Validate', () => {
    it('should transform response data', async () => {
      ...
      vi.spyOn(transport, 'invoke').mockResolvedValue([
        { id: '1', name: 'John' },
        { id: '2', name: 'Jane' },
      ]);
    ...
    it('should use fallback on error', async () => {
      ...
      vi.spyOn(transport, 'invoke').mockRejectedValue(new Error('Network error'));
  ...
  describe('queryInterface (Standard RPC API)', () => {
    ...
    it('should work with direct RPC calls', async () => {
      ...
      vi.spyOn(peer, 'call').mockResolvedValue({ id: '123', name: 'John', email: 'john@example.com' });
