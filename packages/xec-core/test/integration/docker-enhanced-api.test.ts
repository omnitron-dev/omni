...
describe('Docker Enhanced API Integration Tests', () => {
  ...
  describe('Container Lifecycle Management', () => {
    testOrSkip(
      'should create, start, execute, and remove a container',
      async () => {
    ...
    testOrSkip(
      'should handle container with auto-generated name',
      async () => {
        const container = await $.docker({
          image: 'alpine:latest',
          command: 'sleep 3600', // Keep container running
  ...
  describe('Container Configuration', () => {
    ...
    testOrSkip(
      'should create container with port mapping',
      async () => {
        const container = await $.docker({
          image: 'nginx:alpine',
          name: 'xec-test-ports',
    ...
    testOrSkip(
      'should create container with volumes',
      async () => {
    ...
    testOrSkip(
      'should create container with working directory and user',
      async () => {
        const container = await $.docker({
          image: 'alpine:latest',
  ...
  describe('Container Logs', () => {
    ...
    testOrSkip(
      'should follow container logs with timeout',
      async () => {
        const container = await $.docker({
          image: 'alpine:latest',
  ...
  describe('Container Health Checks', () => {
    testOrSkip(
      'should wait for container to be healthy',
      async () => {
  ...
  describe('Container File Operations', () => {
    testOrSkip(
      'should copy files to and from container',
      async () => {
        const container = await $.docker({
          image: 'alpine:latest',
          name: 'xec-test-copy',
  ...
  describe('Container Networking', () => {
    testOrSkip(
      'should get container IP address',
      async () => {
        const container = await $.docker({
          image: 'alpine:latest',
          name: 'xec-test-ip',
    ...
    testOrSkip(
      'should work with custom networks',
      async () => {
        // Create network
  ...
  describe('Error Handling', () => {
    testOrSkip(
      'should handle errors when container operations fail',
      async () => {
        const container = await $.docker({
          image: 'alpine:latest',
  ...
  describe('Backward Compatibility', () => {
    testOrSkip(
      'should work with existing containers using direct execution',
      async () => {
