/**
 * Tests for enhanced @Public decorator with auth, rateLimit, cache, prefetch, audit
 */

import { describe, it, expect } from 'vitest';
import { Public, METADATA_KEYS } from '../../src/decorators/core.js';
import type { MethodOptions } from '../../src/decorators/types.js';

describe('Enhanced @Public Decorator', () => {
