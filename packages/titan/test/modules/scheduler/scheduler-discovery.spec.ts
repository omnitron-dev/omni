...
import { SchedulerDiscovery } from '../../../src/modules/scheduler/scheduler.discovery.js';
...
import { SchedulerModule } from '../../../src/modules/scheduler/scheduler.module.js';
import { Cron, Interval, Timeout, Schedulable } from '../../../src/modules/scheduler/scheduler.decorators.js';
import {
  SCHEDULER_SERVICE_TOKEN,
  SCHEDULER_REGISTRY_TOKEN,
  SCHEDULER_DISCOVERY_TOKEN,
} from '../../../src/modules/scheduler/scheduler.constants.js';
import { CronExpression } from '../../../src/modules/scheduler/scheduler.interfaces.js';
...
describe('SchedulerDiscovery', () => {
  ...
  describe('Provider discovery via container scanning', () => {
    ...
    it('should discover from token-based registrations (useClass)', async () => {
      ...
      const { createToken } = await import('../../../src/nexus/index.js');
