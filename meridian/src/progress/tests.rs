...
mod integration_tests {
    use crate::progress::{ProgressManager, ProgressStorage, Priority, SpecReference, TaskStatus};
    use crate::storage::rocksdb_storage::RocksDBStorage;
    use std::sync::Arc;
    use tempfile::TempDir;

    async fn create_test_setup() -> (ProgressManager, TempDir) {
    ...
    async fn test_multiple_tasks_filtering() {
        ...
        let id1 = manager
            .create_task("Task 1".to_string(), None, Some(Priority::High), None, vec![], None)
            .await
            .unwrap();

        let id2 = manager
            .create_task("Task 2".to_string(), None, Some(Priority::Medium), None, vec![], None)
            .await
            .unwrap();

        let id3 = manager
            .create_task("Task 3".to_string(), None, Some(Priority::Low), None, vec![], None)
            .await
            .unwrap();
    ...
    async fn test_invalid_status_transitions() {
        ...
        let task_id = manager
            .create_task("Test".to_string(), None, None, None, vec![], None)
            .await
            .unwrap();
    ...
    async fn test_delete_task() {
        ...
        let task_id = manager
            .create_task("To be deleted".to_string(), None, None, None, vec![], None)
            .await
            .unwrap();
    ...
    async fn test_cache_functionality() {
        ...
        let task_id = manager
            .create_task("Cached task".to_string(), None, None, None, vec![], None)
            .await
            .unwrap();
    ...
    async fn test_task_history_tracking() {
        ...
        let task_id = manager
            .create_task("History test".to_string(), None, None, None, vec![], None)
            .await
            .unwrap();
    ...
    async fn test_persistence_across_manager_instances() {
        ...
        let task_id = {
            ...
            manager
                .create_task("Persistent task".to_string(), None, None, None, vec![], None)
                .await
                .unwrap()
        };
