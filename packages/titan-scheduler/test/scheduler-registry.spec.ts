...
import { JobStatus, SchedulerJobType, JobPriority } from '../src/scheduler.interfaces.js';
...
describe('Scheduler Registry', () => {
  ...
  describe('Job Registration', () => {
    it('should register a new job', () => {
      const job = registry.registerJob('test-job', SchedulerJobType.CRON, '0 0 * * *', {}, 'execute', {});
  ...
  describe('Job Instance Storage', () => {
    it('should store job instance', () => {
      const _job = registry.registerJob('instance-job', SchedulerJobType.CRON, '* * * * *', {}, 'run', {});
