...
const ReverseInteractor = require('../../../../dist/agent/reverse/ReverseInteractor');
      ...
      let reverse = new ReverseInteractor(
        {
          ...
          PUBLIC_KEY: 'public',
          PM2_REMOTE_METHOD_ALLOWED: ['restart', 'reload', 'reset', 'scale', 'startLogging', 'stopLogging', 'ping'],
        },
        'pm2',
        {
          send: (event, data) => {
