...
$omnitron start ecosystem.json --only sample-normal
...
$omnitron scale sample-normal 4
...
$omnitron scale sample-normal 2
...
$omnitron start ecosystem.json --only sample-other-instance
...
$omnitron start ecosystem.json --only sample-increment
...
$omnitron start ecosystem.json --only sample-normal-fork
...
$omnitron scale sample-normal-fork 4
...
$omnitron scale sample-normal-fork 2
...
$omnitron start ecosystem.json --only sample-other-instance-fork
...
$omnitron start ecosystem.json --only sample-increment-fork
