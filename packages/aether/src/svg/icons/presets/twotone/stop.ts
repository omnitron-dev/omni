...
export const StopIcon: IconDefinition = {
  id: 'stop',
  content:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">\n    <path opacity="0.4" d="M3.5 12C3.5 8.51582 3.5 6.77373 4.36468 5.53884C4.68459 5.08196 5.08196 4.68459 5.53884 4.36468C6.77373 3.5 8.51582 3.5 12 3.5C15.4842 3.5 17.2263 3.5 18.4612 4.36468C18.918 4.68459 19.3154 5.08196 19.6353 5.53884C20.5 6.77373 20.5 8.51582 20.5 12C20.5 15.4842 20.5 17.2263 19.6353 18.4612C19.3154 18.918 18.918 19.3154 18.4612 19.6353C17.2263 20.5 15.4842 20.5 12 20.5C8.51582 20.5 6.77373 20.5 5.53884 19.6353C5.08196 19.3154 4.68459 18.918 4.36468 18.4612C3.5 17.2263 3.5 15.4842 3.5 12Z" stroke-linecap="round" />\n    <path d="M12 20.5C8.51582 20.5 6.77373 20.5 5.53884 19.6353C5.08196 19.3154 4.68459 18.918 4.36468 18.4612C3.5 17.2263 3.5 15.4842 3.5 12C3.5 8.51582 3.5 6.77373 4.36468 5.53884C4.68459 5.08196 5.08196 4.68459 5.53884 4.36468C6.77373 3.5 8.51582 3.5 12 3.5" stroke-linecap="round" />\n  </svg>',
  viewBox: '0 0 24 24',
  width: 24,
  height: 24,
  metadata: {
    preset: 'twotone',
    originalName: 'StopIcon',
    elementsCount: 2,
    hasOpacity: true,
    hasFill: false,
  },
