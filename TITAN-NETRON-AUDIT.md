...
- [ ] **Phase 3** — omnitron app + how titan/omnitron/netron are used across the 8 downstream apps (legacy / dedup / reuse / best-practice conformance). (deferred until after critical framework fixes land)
