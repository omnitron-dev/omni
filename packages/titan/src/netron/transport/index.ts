...
export { WebSocketTransport, WebSocketConnection, WebSocketServerAdapter } from './websocket/index.js';
...
export { WebSocketAuthHandler, createWebSocketAuthHandler } from './websocket/index.js';

// Export types separately (types-only exports for options interfaces)
export type { WebSocketOptions } from './websocket/index.js';
export type { TcpOptions } from './tcp-transport.js';
export type { UnixSocketOptions } from './unix-transport.js';
export type { WebSocketAuthOptions } from './websocket/index.js';
