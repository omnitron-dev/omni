...
import { HealthService, HealthIndicator, CompositeHealthIndicator } from '../../../src/modules/health/index.js';
...
describe('HealthService', () => {
  ...
  describe('check', () => {
    ...
    it('should handle indicator errors gracefully', async () => {
      healthService.registerIndicator(new MockHealthIndicator('test1').setStatus('healthy'));
      healthService.registerIndicator(new MockHealthIndicator('test2').setThrow(new Error('Connection failed')));
...
describe('HealthIndicator', () => {
  class TestIndicator extends HealthIndicator {
    ...
    public async testWithTimeout<T>(operation: () => Promise<T>, timeoutMs: number, timeoutMessage?: string) {
  ...
  describe('withTimeout', () => {
    it('should complete before timeout', async () => {
      const result = await indicator.testWithTimeout(async () => {
        await new Promise((resolve) => setTimeout(resolve, 10));
        return 'done';
      }, 100);
...
describe('CompositeHealthIndicator', () => {
  ...
  describe('constructor', () => {
    ...
    it('should create with initial indicators', () => {
      const indicators = [new MockHealthIndicator('test1'), new MockHealthIndicator('test2')];
  ...
  describe('check', () => {
    ...
    it('should handle errors gracefully', async () => {
      composite.addIndicator(new MockHealthIndicator('test1').setStatus('healthy'));
      composite.addIndicator(new MockHealthIndicator('test2').setThrow(new Error('Check failed')));
