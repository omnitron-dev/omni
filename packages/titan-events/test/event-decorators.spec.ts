...
import { EventMetadataService } from '../src/event-metadata.service';
import { EventDiscoveryService } from '../src/event-discovery.service';
import {
  EVENT_EMITTER_TOKEN,
...
describe('Event Decorators', () => {
  ...
  beforeEach(() => {
    ...
    discoveryService = {
      ...
      registerHandler: vi.fn().mockImplementation(async (metadata: any) => {
    ...
    eventsService.emit = async function emitWithAllEvents(event: string, data?: any, options?: any) {
