...
import { ApplicationState, ApplicationEvent, IModule, ShutdownPriority, IHealthStatus } from '../../src/types.js';
import {
...
describe('Application Integration', () => {
  ...
  describe('Shutdown Management', () => {
    it('should handle shutdown tasks', async () => {
      ...
      const _task1 = app.registerShutdownTask(
        'cleanup-connections',
        async () => {
      ...
      const _task2 = app.registerShutdownTask(
        'save-state',
        async () => {
