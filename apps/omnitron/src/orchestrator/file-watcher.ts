...
export class FileWatcher {
  ...
  private async triggerRestart(app: WatchedApp): Promise<void> {
    ...
    try {
      ...
      // `acme/dev/main`. It also makes a DIFFERENT app named `main` find it,
   ...
   *
   * So every downstream app was watching the daemon's own source tree. Editing one
   ...
   * `/…/apps/omnitron` for payments, messaging, storage and pricing, and
