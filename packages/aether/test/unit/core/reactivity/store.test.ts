...
import { store, effect, computed, createRoot } from '../../../../src/core/reactivity/index.js';
  ...
  describe('Subscriptions', () => {
    ...
    it('should handle multiple subscribers', () => {
      createRoot((d) => {
        ...
        const unsub1 = s.subscribe((state) => {
          count1++;
          last1 = state;
        });
        const unsub2 = s.subscribe((state) => {
          count2++;
          last2 = state;
        });
        const unsub3 = s.subscribe((state) => {
          count3++;
          last3 = state;
        });
