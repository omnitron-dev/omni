/**
 * Netron-specific error classes for browser client
 * Compatible with Titan's Netron error system
 */
...
export class NetronError extends TitanError {
  ...
  constructor(
    ...
    Object.setPrototypeOf(this, NetronError.prototype);
  }
...
export class PeerError extends NetronError {
  constructor(
    ...
    super(options);
    this.name = 'PeerError';
    Object.setPrototypeOf(this, PeerError.prototype);
  }
...
export class SerializationError extends NetronError {
   ...
   * Decode error
   */
  static decode(_data: any, cause?: Error): SerializationError {
    const message = cause?.message ?? 'Failed to decode data';
    return new SerializationError({
      code: ErrorCode.BAD_REQUEST,
      message,
