...
import { Application, Service, OnInit, OnDestroy, type Provider } from '@/index';
import { Injectable, Singleton, Inject, Module } from '@/decorators';
...
describe('DI Integration Tests', () => {
  describe('Complete DI Flow', () => {
    ...
    it('should handle optional dependencies', async () => {
      ...
      const _OptionalToken = createToken<OptionalService>('Optional');
