...
import { EventValidationService } from '../src/event-validation.service';
import { EventHistoryService } from '../src/event-history.service';
import { EVENT_EMITTER_TOKEN } from '../src/events.module';
...
describe('EventSchedulerService', () => {
  ...
  describe('scheduleEvent', () => {
    ...
    it('should schedule event at specific time', async () => {
      ...
      const _jobId = service.scheduleEvent(
        'scheduled.event',
        { data: 'test' },
        {
          at: futureTime,
