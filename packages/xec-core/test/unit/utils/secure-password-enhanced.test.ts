...
describe('SecurePasswordHandler Enhanced Security', () => {
  ...
  describe('Environment configuration for sudo', () => {
    ...
    it('should handle invalid askpass path', () => {
      ...
      expect(() => handler.createSecureEnv(invalidPath)).toThrow('Invalid askpass script path');
    });
    ...
    it('should handle missing password for askpass script', async () => {
      ...
      expect(() => handler.createSecureEnv(scriptPath)).toThrow('Password not found for askpass script');
    });
    ...
    it('should throw when creating secure env after dispose', async () => {
      ...
      expect(() => handler.createSecureEnv(scriptPath)).toThrow('SecurePasswordHandler has been disposed');
    });
  });
  ...
  describe('Password strength validation', () => {
    it('should validate strong passwords', () => {
      const strongPasswords = ['P@ssw0rd123!', 'MyStr0ng!Pass#2023', 'C0mpl3x&P@ssw0rd'];
