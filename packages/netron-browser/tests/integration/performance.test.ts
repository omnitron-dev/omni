...
describe.skip('Performance Benchmarks - WebSocket', () => {
  ...
  describe('Throughput Benchmarks', () => {
    ...
    }, 120000); // 120 second timeout for 500 sequential operations
...
// TODO: Skipped for the same reason as the WebSocket-only tests above
describe.skip('Performance Benchmarks - HTTP vs WebSocket', () => {
  let server: TitanServerFixture;
