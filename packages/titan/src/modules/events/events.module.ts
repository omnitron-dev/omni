...
import { Module, Global, Container, createToken } from '@omnitron-dev/nexus';
...
export const EVENTS_SERVICE_TOKEN = createToken<EventsService>('EventsService');
export const EVENT_METADATA_SERVICE_TOKEN = createToken<EventMetadataService>('EventMetadataService');
export const EVENT_DISCOVERY_SERVICE_TOKEN = createToken<EventDiscoveryService>('EventDiscoveryService');
export const EVENT_BUS_SERVICE_TOKEN = createToken<EventBusService>('EventBusService');
